...
$members = Import-CSV "C:\DATA\csv\fim_MoodleUsersCombined.csv" -Encoding UTF8
# Check for the length of the import so you don't overwrite the content
$memberCount = (Import-CSV "C:\DATA\csv\fim_MoodleUsersCombined.csv").count

$CUSTOMmembers = Import-CSV "C:\DATA\csv\MoodleUSERS_CUSTOM.csv" -Encoding UTF8
